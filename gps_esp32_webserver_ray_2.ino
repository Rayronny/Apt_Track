// 26 March working code Happy RAy esp32
...
const char* SERVER_NAME = "https://apttrack-server.onrender.com/api/locations/items";//"https://apttrackray.000webhostapp.com/gpsdata.php?lat=";"https:cuthub.atwebpages.com/gpsdata.php";

//ESP32_API_KEY is the exact duplicate of, ESP32_API_KEY in config.php file
//Both values must be same
String ESP32_API_KEY = "Module 1";
//NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
...
#define rxPin 16 //module 1
#define txPin 17
//#define rxPin 19
//#define txPin 18 // module 2 
...
int sendGpsToServer()
{
  ...
  if(true){
    ...
    //NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
    String latitude, longitude , altitude , date, time , speed ;
    //float altitude;
